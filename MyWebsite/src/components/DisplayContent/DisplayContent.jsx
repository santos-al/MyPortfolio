      ...
      >
        <div className='section-column sm:w-1/2 w-full text-column'>
          ...
          <div className="github-link-section">
            <a className="github-link" aria-label="View github" target="_blank" href={contentList.link} style={contentList.specialStyle.primary ? contentList.specialStyle.primary : undefined}>
              More Details
            </a>
          </div>
        </div>
